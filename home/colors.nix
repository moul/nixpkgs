...

{
  ...
  # https://github.com/moul/colorscheme
  colors.manfred-touron = {
    colors = {
      ...
      color9 = "#ff008b"; # Bright Red
      # green
      color2 = "#51ff0f"; # Default Green
      color10 = "#62c750"; # Bright Green
      # yellow
      color3 = "#e7a800"; # Default Yellow
      color11 = "#f4ff00"; # Bright Yellow
      # blue
      color4 = "#3950d7"; # Default Blue
      color12 = "#70a5ed"; # Bright Blue
      # megenta
      color5 = "#d336b1"; # Default Magenta
      color13 = "#b867e6"; # Bright Magenta
      # cyan
      color6 = "#66b2ff"; # Default Cyan
      color14 = "#00d4fc"; # Bright Cyan
      # white
      color7 = "#cecece"; # Default White
      color15 = "#ffffff"; # Bright White
